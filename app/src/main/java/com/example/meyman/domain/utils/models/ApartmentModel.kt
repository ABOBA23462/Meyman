...
data class ApartmentModel (
    ...
    val next: String,
    val previous: String,
    val results: List<ApartmentItemModel>
)

data class ApartmentItemModel(
    ...
    val housing_amenities: ApartmentAmenitiesModel,
    val housing_name: String,
    val housing_type: String,
    val image: String,
    val location: String,
    val price_per_night: String,
    val room_amenities: ApartmentRoomAmenitiesModel
)

data class ApartmentAmenitiesModel(
...
data class ApartmentRoomAmenitiesModel(
