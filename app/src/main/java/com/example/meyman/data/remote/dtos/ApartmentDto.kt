...
data class ApartmentDto(
    ...
    val next: String,
    val previous: String,
    val results: List<ApartmentItemDto>
)

data class ApartmentItemDto(
    ...
    val housing_amenities: ApartmentAmenitiesDto,
    ...
    val room_amenities: ApartmentRoomAmenitiesDto
)

data class ApartmentAmenitiesDto(
...
data class ApartmentRoomAmenitiesDto(
