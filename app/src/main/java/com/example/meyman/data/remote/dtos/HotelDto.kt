...
data class HotelItemDto(
    ...
    val housing_amenities: HotelAmenitiesDto,
    ...
    val room_amenities: HotelRoomAmenitiesDto
)

data class HotelAmenitiesDto(
...
data class HotelRoomAmenitiesDto(
