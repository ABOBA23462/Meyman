...
data class SanatoriumDto(
    ...
    val next: String,
    val previous: String,
    val results: List<SanatoriumItemDto>
)

data class SanatoriumItemDto(
    ...
    val housing_amenities: SanatoriumAmenitiesDto,
    ...
    val room_amenities: SanatoriumRoomAmenitiesDto
)

data class SanatoriumAmenitiesDto(
...
data class SanatoriumRoomAmenitiesDto(
