...
data class GuestHouseDto(
    ...
    val next: String,
    val previous: String,
    val results: List<GuestHouseItemDto>
)

data class GuestHouseItemDto(
    ...
    val housing_amenities: GuestHouseAmenitiesDto,
    ...
    val room_amenities: GuestRoomAmenitiesDto
)

data class GuestHouseAmenitiesDto(
...
data class GuestRoomAmenitiesDto(
