...
data class HostelDto(
    ...
    val next: String,
    val previous: String,
    val results: List<HostelItemDto>
)

data class HostelItemDto(
    ...
    val housing_amenities: HostelAmenitiesDto,
    ...
    val room_amenities: HostelRoomAmenitiesDto
)

data class HostelAmenitiesDto(
...
data class HostelRoomAmenitiesDto(
