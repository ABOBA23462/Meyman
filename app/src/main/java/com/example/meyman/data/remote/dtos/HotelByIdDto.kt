...
data class Room(
    ...
    val room_images: List<RoomImageData>
)

fun Room.toDomain() = com.example.meyman.domain.utils.models.Room(bed_type,
    max_guest_capacity,
    num_rooms,
    price_per_night,
    room_amenities,
...
data class HousingImage(
    ...
    val housing: Int,
    @SerializedName("id_housing")
    val id: Int,
    @SerializedName("image_housing")
    val image: String
)

fun HousingImage.toDomain() = com.example.meyman.domain.utils.models.HousingImage(
    housing, id, image
)
...
fun Review.toDomain() = com.example.meyman.domain.utils.models.Review(
    cleanliness_rating,
    comfort_rating,
    comment,
    date_added,
...
fun RoomImageData.toDomain() = RoomImageDomain(
    id, image, room
)